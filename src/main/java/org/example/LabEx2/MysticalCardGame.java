...
public class MysticalCardGame {
    ...
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        ...
        while (firstSorcerer!=null){
            if(mostSig.element.significance()<firstSorcerer.element.significance()){
                mostSig=firstSorcerer;
            }
        ...
        secondSorcererCards.insertBefore(mostSig.element,secondSorcerer);
